...
#ifndef CLASSIFIER_POOLING_ENTITY_H_
#define CLASSIFIER_POOLING_ENTITY_H_
...
class Classifier_pooling_entity {
public:
	Options options;
	...
	Classifier_pooling_entity(const Options& options):options(options) {
