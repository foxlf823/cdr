...
#ifndef SRC_PoolExGRNNandRecursiveNNClassifier8_H_
#define SRC_PoolExGRNNandRecursiveNNClassifier8_H_
...
class PoolExGRNNandRecursiveNNClassifier8 {
public:
	PoolExGRNNandRecursiveNNClassifier8() {
    _dropOut = 0.5;
  }
  ~PoolExGRNNandRecursiveNNClassifier8() {
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, Options options) {
    ...
    cout<<"PoolExGRNNandRecursiveNNClassifier8 initial"<<endl;
    cout<< "SemiDep" <<endl;
