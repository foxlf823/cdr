...
/*	virtual ~Classifier() {
	...
	void init(const NRMat<dtype>& wordEmb, const NRMat<dtype>& wordnetEmb, const NRMat<dtype>& brownEmb,
	    ...
	    if(bWordnet) {
			...
			_wordnet.setEmbFineTune(options.wordEmbFineTune);
	    ...
	    if(bBrown) {
			...
			_brown.setEmbFineTune(options.wordEmbFineTune);
	    ...
	    if(bBigram) {
			...
			_bigram.setEmbFineTune(options.wordEmbFineTune);
	    ...
	    if(bPos) {
			_pos.initial(posEmb);
			_pos.setEmbFineTune(options.wordEmbFineTune);
	    ...
	    if(bSst) {
			_sst.initial(sstEmb);
			_sst.setEmbFineTune(options.wordEmbFineTune);
