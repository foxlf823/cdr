...
/*      penul = NewTensor<xpu>(Shape2(1, _penulSize), 0.0);
      penulLoss = NewTensor<xpu>(Shape2(1, _penulSize), 0.0);*/
      //forward propagation
     ...
     // _penul_layer.ComputeForwardScore(poolmerge, penul);
      ...
      //_penul_layer.ComputeBackwardLoss(poolmerge, penul, penulLoss, poolmergeLoss);
...
/*      FreeSpace(&penul);
  ...
  void updateParams(dtype nnRegular, dtype adaAlpha, dtype adaEps) {
    ...
    //_penul_layer.updateAdaGrad(nnRegular, adaAlpha, adaEps);
