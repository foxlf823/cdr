...
#ifndef SRC_PoolExGRNNClassifier1_H_
#define SRC_PoolExGRNNClassifier1_H_
...
class PoolExGRNNClassifier1 {
public:
	PoolExGRNNClassifier1() {
    _dropOut = 0.5;
  }
  ~PoolExGRNNClassifier1() {
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, Options options) {
    ...
    cout<<"PoolExGRNNClassifier g3 initial"<<endl;
  }
  ...
  inline dtype process(const vector<Example>& examples, int iter) {
    ...
    for (int count = 0; count < example_num; count++) {
      ...
      _target_attention.ComputeBackwardLoss(former_input_span[0], former_input_span[2], former_input_span[1],
          ...
          former_input_spanLoss[0], former_input_spanLoss[2], former_input_spanLoss[1]);
      ...
      _target_attention.ComputeBackwardLoss(latter_input_span[0], latter_input_span[2], latter_input_span[1],
          ...
          latter_input_spanLoss[0], latter_input_spanLoss[2], latter_input_spanLoss[1]);
