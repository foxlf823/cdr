...
#ifndef SRC_PoolGRNNandRecursiveNNClassifier1_H_
#define SRC_PoolGRNNandRecursiveNNClassifier1_H_
...
class PoolGRNNandRecursiveNNClassifier1 {
public:
	PoolGRNNandRecursiveNNClassifier1() {
    _dropOut = 0.5;
  }
  ~PoolGRNNandRecursiveNNClassifier1() {
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, Options options) {
    ...
    cout<<"PoolGRNNandRecursiveNNClassifier1 initial"<<endl;
    cout<<"DepRecursiveNN"<<endl;
  }
